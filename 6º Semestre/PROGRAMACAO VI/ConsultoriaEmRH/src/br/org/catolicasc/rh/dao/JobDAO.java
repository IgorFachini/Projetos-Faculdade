...
public class JobDAO extends JpaDaoBase<Job>{
...
//	private static Course course1 = new Course( "Matematica ", "22:00", CourseType.LANGUAGE, "Catolicasc", "Jaragua do sul");
//	private static Course course2 = new Course( "Matematica2 ", "22:00", CourseType.LANGUAGE, "Catolicasc", "Jaragua do sul");
//
//	static {
//		job1.setId(1L);
//		job1.setId(2L);
